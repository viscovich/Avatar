...
import { Loader2, Wand2, Settings2, RefreshCw, MonitorPlay } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col h-full bg-white rounded-lg shadow-sm border overflow-hidden">
            ...
            <div className="flex justify-center bg-gray-100 p-4 border-b">
                <div
                    className={`relative bg-gray-900 overflow-hidden group shadow-lg transition-all duration-300 ${aspectRatio === '16:9' ? 'w-full aspect-video' : 'h-[400px] aspect-[9/16]'
                        }`}
                >
                    {/* Background Layer */}
                    <div
            ...
            <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                ...
                <div className="space-y-3">
                    <div>
                        ...
                        <textarea
                            className="w-full p-2 text-sm border rounded-md focus:ring-1 focus:ring-blue-500 min-h-[80px] resize-none"
                ...
                <div className="border-t pt-3">
                    <button
                        ...
                        className="flex items-center justify-between w-full text-xs font-medium text-gray-700 mb-3 hover:text-blue-600"
                    >
                        <span className="flex items-center"><Settings2 className="w-3 h-3 mr-1" /> Visual Settings</span>
                    ...
                    {showAdvanced && (
                        <div className="space-y-4 bg-gray-50 p-3 rounded-md text-xs">
                            ...
                            <div className="flex items-center justify-between p-2 bg-white border rounded-md">
                                ...
                                <div className="flex space-x-2">
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded text-xs ${aspectRatio === '9:16' ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-500 hover:bg-gray-100'}`}
                                    >
                                        9:16 (Vertical)
                                    </button>
                                    <button
                                        onClick={() => setAspectRatio('16:9')}
                                        className={`px-3 py-1 rounded text-xs ${aspectRatio === '16:9' ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-500 hover:bg-gray-100'}`}
                                    >
                                        16:9 (Landscape)
                                    </button>
                                </div>
                            ...
                            {/* Background */}
                            <div>
                                <label className="block text-gray-600 mb-2">Background</label>
                                <div className="flex items-center space-x-2">
                                    <input
                                        ...
                                        className="h-8 w-8 border rounded cursor-pointer p-0.5 bg-white"
                                    />
                                    <div className="flex-1 grid grid-cols-4 gap-1">
                                        {['#1a2332', '#000000', '#ffffff', '#2d3748'].map(color => (
                                            <button
                                                key={color}
                                                onClick={() => {
                                                ...
                                                className={`h-6 rounded border ${backgroundColor === color && backgroundType === 'color' ? 'ring-2 ring-blue-500' : 'border-gray-200'}`}
            ...
            <div className="p-3 border-t bg-gray-50">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-md text-sm font-medium transition-colors disabled:opacity-50"
                >
